...
func (p *TIOError) String() string {
	...
	return fmt.Sprintf("TIOError(%+v)", *p.Message)
}
...
func (p *THBaseServiceClient) Exists(ctx context.Context, table []byte, tget *TGet) (r bool, err error) {
	var _args23 THBaseServiceExistsArgs
	_args23.Table = table
	_args23.Tget = tget
	var _result24 THBaseServiceExistsResult
	if err = p.Client_().Call(ctx, "exists", &_args23, &_result24); err != nil {
		return
	}
	switch {
	case _result24.Io != nil:
		return r, _result24.Io
	}
...
func (p *THBaseServiceClient) ExistsAll(ctx context.Context, table []byte, tgets []*TGet) (r []bool, err error) {
	var _args25 THBaseServiceExistsAllArgs
	_args25.Table = table
	_args25.Tgets = tgets
	var _result26 THBaseServiceExistsAllResult
	if err = p.Client_().Call(ctx, "existsAll", &_args25, &_result26); err != nil {
		return
	}
	switch {
	case _result26.Io != nil:
		return r, _result26.Io
	}
...
func (p *THBaseServiceClient) Get(ctx context.Context, table []byte, tget *TGet) (r *TResult_, err error) {
	var _args27 THBaseServiceGetArgs
	_args27.Table = table
	_args27.Tget = tget
	var _result28 THBaseServiceGetResult
...
func (p *THBaseServiceClient) GetMultiple(ctx context.Context, table []byte, tgets []*TGet) (r []*TResult_, err error) {
	var _args29 THBaseServiceGetMultipleArgs
	_args29.Table = table
	_args29.Tgets = tgets
	var _result30 THBaseServiceGetMultipleResult
	if err = p.Client_().Call(ctx, "getMultiple", &_args29, &_result30); err != nil {
		return
	}
	switch {
...
func (p *THBaseServiceClient) Put(ctx context.Context, table []byte, tput *TPut) (err error) {
	var _args31 THBaseServicePutArgs
	_args31.Table = table
	_args31.Tput = tput
	var _result32 THBaseServicePutResult
	if err = p.Client_().Call(ctx, "put", &_args31, &_result32); err != nil {
		return
	}
	switch {
...
func (p *THBaseServiceClient) CheckAndPut(ctx context.Context, table []byte, row []byte, family []byte, qualifier []byte, value []byte, tput *TPut) (r bool, err error) {
	var _args33 THBaseServiceCheckAndPutArgs
	_args33.Table = table
	_args33.Row = row
	_args33.Family = family
	_args33.Qualifier = qualifier
	_args33.Value = value
	_args33.Tput = tput
	var _result34 THBaseServiceCheckAndPutResult
	if err = p.Client_().Call(ctx, "checkAndPut", &_args33, &_result34); err != nil {
		return
	}
	switch {
...
func (p *THBaseServiceClient) PutMultiple(ctx context.Context, table []byte, tputs []*TPut) (err error) {
	var _args35 THBaseServicePutMultipleArgs
	_args35.Table = table
	_args35.Tputs = tputs
	var _result36 THBaseServicePutMultipleResult
	if err = p.Client_().Call(ctx, "putMultiple", &_args35, &_result36); err != nil {
		return
	}
	switch {
...
func (p *THBaseServiceClient) DeleteSingle(ctx context.Context, table []byte, tdelete *TDelete) (err error) {
	var _args37 THBaseServiceDeleteSingleArgs
	_args37.Table = table
	_args37.Tdelete = tdelete
	var _result38 THBaseServiceDeleteSingleResult
	if err = p.Client_().Call(ctx, "deleteSingle", &_args37, &_result38); err != nil {
		return
	}
	switch {
...
func (p *THBaseServiceClient) DeleteMultiple(ctx context.Context, table []byte, tdeletes []*TDelete) (r []*TDelete, err error) {
	var _args39 THBaseServiceDeleteMultipleArgs
	_args39.Table = table
	_args39.Tdeletes = tdeletes
	var _result40 THBaseServiceDeleteMultipleResult
	if err = p.Client_().Call(ctx, "deleteMultiple", &_args39, &_result40); err != nil {
		return
	}
	switch {
...
func (p *THBaseServiceClient) CheckAndDelete(ctx context.Context, table []byte, row []byte, family []byte, qualifier []byte, value []byte, tdelete *TDelete) (r bool, err error) {
	var _args41 THBaseServiceCheckAndDeleteArgs
	_args41.Table = table
	_args41.Row = row
	_args41.Family = family
	_args41.Qualifier = qualifier
	_args41.Value = value
	_args41.Tdelete = tdelete
	var _result42 THBaseServiceCheckAndDeleteResult
	if err = p.Client_().Call(ctx, "checkAndDelete", &_args41, &_result42); err != nil {
		return
	}
	switch {
...
func (p *THBaseServiceClient) Increment(ctx context.Context, table []byte, tincrement *TIncrement) (r *TResult_, err error) {
	var _args43 THBaseServiceIncrementArgs
	_args43.Table = table
	_args43.Tincrement = tincrement
	var _result44 THBaseServiceIncrementResult
	if err = p.Client_().Call(ctx, "increment", &_args43, &_result44); err != nil {
		return
	}
	switch {
...
func (p *THBaseServiceClient) Append(ctx context.Context, table []byte, tappend *TAppend) (r *TResult_, err error) {
	var _args45 THBaseServiceAppendArgs
	_args45.Table = table
	_args45.Tappend = tappend
	var _result46 THBaseServiceAppendResult
	if err = p.Client_().Call(ctx, "append", &_args45, &_result46); err != nil {
		return
	}
	switch {
...
func (p *THBaseServiceClient) OpenScanner(ctx context.Context, table []byte, tscan *TScan) (r int32, err error) {
	var _args47 THBaseServiceOpenScannerArgs
	_args47.Table = table
	_args47.Tscan = tscan
	var _result48 THBaseServiceOpenScannerResult
	if err = p.Client_().Call(ctx, "openScanner", &_args47, &_result48); err != nil {
		return
	}
	switch {
...
func (p *THBaseServiceClient) GetScannerRows(ctx context.Context, scannerId int32, numRows int32) (r []*TResult_, err error) {
	var _args49 THBaseServiceGetScannerRowsArgs
	_args49.ScannerId = scannerId
	_args49.NumRows = numRows
	var _result50 THBaseServiceGetScannerRowsResult
	if err = p.Client_().Call(ctx, "getScannerRows", &_args49, &_result50); err != nil {
		return
	}
	switch {
	case _result50.Io != nil:
		return r, _result50.Io
	case _result50.Ia != nil:
		return r, _result50.Ia
	}
...
func (p *THBaseServiceClient) CloseScanner(ctx context.Context, scannerId int32) (err error) {
	var _args51 THBaseServiceCloseScannerArgs
	_args51.ScannerId = scannerId
	var _result52 THBaseServiceCloseScannerResult
	if err = p.Client_().Call(ctx, "closeScanner", &_args51, &_result52); err != nil {
		return
	}
	switch {
...
func (p *THBaseServiceClient) MutateRow(ctx context.Context, table []byte, trowMutations *TRowMutations) (err error) {
	var _args53 THBaseServiceMutateRowArgs
	_args53.Table = table
	_args53.TrowMutations = trowMutations
	var _result54 THBaseServiceMutateRowResult
	if err = p.Client_().Call(ctx, "mutateRow", &_args53, &_result54); err != nil {
		return
	}
	switch {
...
func (p *THBaseServiceClient) GetScannerResults(ctx context.Context, table []byte, tscan *TScan, numRows int32) (r []*TResult_, err error) {
	var _args55 THBaseServiceGetScannerResultsArgs
	_args55.Table = table
	_args55.Tscan = tscan
	_args55.NumRows = numRows
	var _result56 THBaseServiceGetScannerResultsResult
	if err = p.Client_().Call(ctx, "getScannerResults", &_args55, &_result56); err != nil {
		return
	}
	switch {
	case _result56.Io != nil:
		return r, _result56.Io
	}
...
func (p *THBaseServiceClient) GetRegionLocation(ctx context.Context, table []byte, row []byte, reload bool) (r *THRegionLocation, err error) {
	var _args57 THBaseServiceGetRegionLocationArgs
	_args57.Table = table
	_args57.Row = row
	_args57.Reload = reload
	var _result58 THBaseServiceGetRegionLocationResult
	if err = p.Client_().Call(ctx, "getRegionLocation", &_args57, &_result58); err != nil {
		return
	}
	switch {
...
func (p *THBaseServiceClient) GetAllRegionLocations(ctx context.Context, table []byte) (r []*THRegionLocation, err error) {
	var _args59 THBaseServiceGetAllRegionLocationsArgs
	_args59.Table = table
	var _result60 THBaseServiceGetAllRegionLocationsResult
	if err = p.Client_().Call(ctx, "getAllRegionLocations", &_args59, &_result60); err != nil {
		return
	}
	switch {
	case _result60.Io != nil:
		return r, _result60.Io
	}
...
func (p *THBaseServiceClient) CheckAndMutate(ctx context.Context, table []byte, row []byte, family []byte, qualifier []byte, compareOp TCompareOp, value []byte, rowMutations *TRowMutations) (r bool, err error) {
	var _args61 THBaseServiceCheckAndMutateArgs
	_args61.Table = table
	_args61.Row = row
	_args61.Family = family
	_args61.Qualifier = qualifier
	_args61.CompareOp = compareOp
	_args61.Value = value
	_args61.RowMutations = rowMutations
	var _result62 THBaseServiceCheckAndMutateResult
	if err = p.Client_().Call(ctx, "checkAndMutate", &_args61, &_result62); err != nil {
		return
	}
	switch {
	case _result62.Io != nil:
		return r, _result62.Io
	}
